...
This directory contains Jupyter notebooks for the SageMaker AIOps Workshop - Model Deployment and Monitoring module.
...
2. **SageMaker Domain**: Properly configured

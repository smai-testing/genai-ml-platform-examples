# Automate AIOps with Amazon SageMaker projects - Model Build
...
1. **Configure Glue Data Source**: Create Glue table in SageMaker and update GitHub secrets with actual database and table names.
...
2. Select "Sagemaker Pipeline build"
...
2. **Glue database/table not found**:
   ...
   - **Solution**: Update secrets with actual database and table names from SageMaker

...
def convert_struct(str_struct=None):
    """Convert string representation of dict/list to actual Python object.
    
    Args:
        str_struct: String representation of a Python structure
        
    Returns:
        Python object (dict, list, etc.) or empty dict if None
    """
...
def get_pipeline_custom_tags(module_name, args, tags):
    ...
    Args:
        module_name: The module name of your pipeline
        args: String representation of arguments dict
        tags: Base tags list
